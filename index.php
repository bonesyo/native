...
<body>
    ...
    <div class="main-div">
        ...
        <div class="tree-house">
            <div class="banner">
                <img src="./images/tree_house_banner.png" usemap="#map-tree-house"/>
                <map name="map-tree-house" id="map-tree-house">
                    <area title="click-for-more" href="//www.munchandco.com" target="_blank" shape="rect" coords="310,187,659,215" />
                </map>
            </div>
        </div>
